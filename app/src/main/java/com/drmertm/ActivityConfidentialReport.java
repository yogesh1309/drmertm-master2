...
public class ActivityConfidentialReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confidential_report);

        sessionManager = new SessionManager(ActivityConfidentialReport.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ActivityConfidentialReport.this, android.R.layout.simple_spinner_item, yearnamelist);
...
//                        Toast.makeText(ActivityForm16.this, "Please select year!", Toast.LENGTH_SHORT).show();
                    ...
                    else
                    {
                        if(isConnectingToInternet()) {
                            ...
                            CustomAlertdialog.createDialog(ActivityConfidentialReport.this,getString(R.string.no_internet));
                        }
                    }
    ...
    private void Click() {
        ...
        txt_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (year.equals("Select Year"))
                {
                    Toast.makeText(ActivityConfidentialReport.this, "Please select year!", Toast.LENGTH_SHORT).show();
                    wv_pdf.setVisibility(View.GONE);
                }
                else {

                    Toast.makeText(ActivityConfidentialReport.this, "Please Wait...", Toast.LENGTH_SHORT).show();
                    ...
                    WebViewClient yourWebClient = new WebViewClient() {
                        ...
                        public void onPageStarted(WebView view, String url, Bitmap favicon) {
                            ...
                            Customprogress.showPopupProgressSpinner(ActivityConfidentialReport.this,true);
                        }
                        ...
                        public void onPageFinished(WebView view, String url) {
                            Customprogress.showPopupProgressSpinner(ActivityConfidentialReport.this,false);
                        }
...
//                    Intent intent = new Intent(ActivityConfidentialReport.this,Activitywebview.class);
...
//                    startActivity(intent);
        ...
        txt_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if (isConnectingToInternet())
                        if (ContextCompat.checkSelfPermission(ActivityConfidentialReport.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(ActivityConfidentialReport.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CAMERA);
                        } else {
//                            new DownloadTask(ActivityConfidentialReport.this, url);
                        ...
                        Toast.makeText(ActivityConfidentialReport.this, "Oops!! There is no internet connection. Please enable internet connection and try again.", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(getApplicationContext(), "Permission denied", Toast.LENGTH_SHORT).show();
    ...
    public void sendform16(String empid, String year) {
        Customprogress.showPopupProgressSpinner(ActivityConfidentialReport.this,true);
        mAPIService.confidentialreport(empid,year).enqueue(new Callback<Form16Response>() {
            @Override
    ...
    private void openDownloadedFolder() {
        ...
        if (new CheckForSDCard().isSDCardPresent()) {
            ...
            if (!apkStorage.exists())
                Toast.makeText(ActivityConfidentialReport.this, "Right now there is no directory. Please download some file first.", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ActivityConfidentialReport.this, "Oops!! There is no SD Card.", Toast.LENGTH_SHORT).show();
...
//        public static final String mainUrl = "https://cybraze.com/drmertm/uploads/CR/";
//        public static final String mainUrl = "http://103.82.146.90/uploads/CR/";
        public static final String mainUrl = "https://drmertm.in/uploads/CR/";
//        public static final String mainUrl = "http://103.82.146.90/uploads/CR/";
    }
...
//                            buttonText.setText(R.string.downloadAgain);
    ...
    public void ShowNotification (String name)
    {
        ...
        Intent intent = new Intent(ActivityConfidentialReport.this,ActivityWebViewOffline.class);
        intent.putExtra("data","Confidential Report");
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);

        Uri defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(ActivityConfidentialReport.this, Constants.CHANNEL_ID);
        ...
        NotificationManager notificationManager = (NotificationManager) ActivityConfidentialReport.this.getSystemService(Context.NOTIFICATION_SERVICE);
